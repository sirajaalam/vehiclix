    ...
    <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8 space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-7 rounded-[18px] border border-white/[0.08] bg-slate-900/60 p-6 sm:p-8 backdrop-blur-md shadow-[0_8px_30px_rgba(0,0,0,0.4)]">
          {/* Mode Switcher */}
          <div className="mb-6 flex items-center p-1 bg-slate-950/80 rounded-[12px] border border-white/[0.08]">
            <button
              type="button"
              onClick={() => setCalcMode('distance')}
              className={`flex-1 flex items-center justify-center gap-2 py-2 text-xs font-semibold rounded-[10px] transition-all cursor-pointer ${
                calcMode === 'distance'
